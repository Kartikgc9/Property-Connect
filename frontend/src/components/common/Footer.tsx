        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4">
              Connecting buyers with the best real estate agents. Find your dream property with blockchain-verified listings and AI-powered insights.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">info@propertyconnect.com</span>
              </div>
            </div>
          </div>
        </div>
