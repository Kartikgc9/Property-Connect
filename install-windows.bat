@echo off
echo ========================================
echo PropertyConnect Windows Installation
echo ========================================
echo.
...
if %errorlevel% neq 0 (
    echo WARNING: Some AI dependencies failed to install, trying individual packages...
...
echo.
echo Downloading spaCy model for AI service...
cd ai
